    ...
    <div className="flex flex-col sm:flex-row justify-center gap-6 sm:gap-8 py-20">
      <div className="w-full bg-white/5 sm:w-1/2 bg-transparent rounded-lg overflow-hidden border border-white/70">
        <table className={`w-full text-sm ${playfair.className}`}>
          <thead>
            <tr>
              <th colSpan={2} className="py-2 px-4 text-white text-2xl bg-black/50 font-normal border-b border-white/50">
                Dimensions
              </th>
            </tr>
          </thead>
      ...
      <div className="w-full bg-white/5 sm:w-1/2 bg-transparent rounded-lg overflow-hidden border border-white/70">
        <table className={`w-full text-sm ${playfair.className}`}>
          <thead>
            <tr>
              <th colSpan={2} className="py-2 px-4 text-white bg-black/50 text-2xl font-normal border-b border-white/50">
                Accommodation
              </th>
            </tr>
          </thead>
